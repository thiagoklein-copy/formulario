          ...
          <StepWrapper title={meta.title} description={meta.description}>
            ...
            {step === 6 && (
              <>
                ...
                <QuestionRadio label="Orcamento mensal para marketing?" value={responses.orcamento_marketing} onChange={(value) => update("orcamento_marketing", value)} options={["Ate R$ 1.000/mes", "R$ 1.000 a R$ 3.000/mes", "R$ 3.000 a R$ 10.000/mes", "Acima de R$ 10.000/mes", "Ainda a definir"]} error={hasError("orcamento_marketing")} />
